package com.jeholppx.bbgbackendanswerservice.controller;

import cn.hutool.core.util.IdUtil;
import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;

import com.jeholppx.bbgbackendanswerservice.scoring.ScoringStrategyExecutor;
import com.jeholppx.bbgbackendanswerservice.service.UserAnswerService;
...
import com.jeholppx.bbgbackendmodel.model.dto.userAnswer.UserAnswerAddRequest;
import com.jeholppx.bbgbackendmodel.model.dto.userAnswer.UserAnswerEditRequest;
import com.jeholppx.bbgbackendmodel.model.dto.userAnswer.UserAnswerQueryRequest;
import com.jeholppx.bbgbackendmodel.model.dto.userAnswer.UserAnswerUpdateRequest;
...
import com.jeholppx.bbgbackendmodel.model.enums.ReviewStatusEnum;
import com.jeholppx.bbgbackendmodel.model.vo.UserAnswerVO;
...
public class UserAnswerController {
    ...
    public BaseResponse<Boolean> deleteUserAnswer(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可删除
        if (!oldUserAnswer.getUserId().equals(user.getId()) && !userFeignClient.isAdmin(user)) {
    ...
    public BaseResponse<Boolean> editUserAnswer(@RequestBody UserAnswerEditRequest userAnswerEditRequest, HttpServletRequest request) {
        ...
        ThrowUtils.throwIf(oldUserAnswer == null, ErrorCode.NOT_FOUND_ERROR);
        // 仅本人或管理员可编辑
        if (!oldUserAnswer.getUserId().equals(loginUser.getId()) && !userFeignClient.isAdmin(loginUser)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
        // 操作数据库
        boolean result = userAnswerService.updateById(userAnswer);
